...
import com.creedon.app.R;
import com.creedon.app.databinding.VideoSelectLayoutBinding;
...
public class VideoSelectActivity extends AppCompatActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		mBinding = DataBindingUtil.setContentView(VideoSelectActivity.this, R.layout.video_select_layout);
		...
		rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE).subscribe(new Consumer<Boolean>() {
			...
			public void accept(Boolean granted) throws Exception {
				...
				if (granted) { // Always true pre-M
					mVideoLoadManager.load(VideoSelectActivity.this, new SimpleCallback() {
						...
						public void success(Object obj) {
							if (mVideoSelectAdapter == null) {
								...
								mVideoSelectAdapter.setItemClickCallback(new SingleCallback<Boolean, String>() {
									@Override
									public void onSingleCallback(Boolean isSelected, String videoPath) {
